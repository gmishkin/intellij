...
public class BlazeAndroidWorkspaceImporter {
  ...
  static class LibraryFactory {
    ...
    /**
     * Creates a new Aar repository for an AAR only has resources. Returns the key for the library
     * or null if no aar exists for this target.
     */
    @Nullable
    public String createAarLibrary(@NotNull ArtifactLocation aar) {
      if (aar == null) {
        return null;
      }
